-- ============================================================================
-- 个人笔记系统 · 数据库设计 DDL
-- 适用数据库: MySQL 8.0+ (utf8mb4)
-- 设计依据: 前端 Vue 3 + Element Plus 笔记应用, 涵盖用户/笔记/标签/
--           关注/点赞/收藏等核心业务
-- ============================================================================
-- 当前文件存储的问题:
--   1. data/notes/users/{userId}/notes/{title}.md 将每篇笔记存为独立文件,
--      无法存储标题/标签/时间等元数据, 文件名冲突时直接丢失数据
--   2. data/notes/users/{userId}/avatar/avatar.jpg 头像路径写死, 无法多图/切换
--   3. 点赞、关注、收藏等关系完全不存在, 用户间社交功能无法实现
--   4. 没有全文搜索能力, 标题/内容检索只能靠操作系统文件名匹配
-- ============================================================================
